...
from rest_framework.fields import CharField, ChoiceField, DateTimeField, DictField, empty
...
class LogEvent:
    ...
    def from_event_dict(item: EventDict) -> "LogEvent":
        ...
        return LogEvent(event, log_level, item.pop("logger"), timestamp, attributes=item)
...
class LogEventSerializer(PassiveSerializer):
    ...
    #         return super().to_representation(LogEvent(
    #             event=instance,
    #             log_level="info",
    #             logger="",
    #         ))
